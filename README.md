...
3.  配置环境变量（可选）:
    ...
    # 编辑 .env.local，添加你的 Google Analytics ID
    # NEXT_PUBLIC_GA_ID=G-XXXXXXXXXX
    ```
    详细的 Google Analytics 配置说明请查看 [ANALYTICS_SETUP.md](./ANALYTICS_SETUP.md)
...
- `NEXT_PUBLIC_GA_ID`: 你的 Google Analytics 衡量ID（格式：G-XXXXXXXXXX）

详细说明请参考 [ANALYTICS_SETUP.md](./ANALYTICS_SETUP.md)

## 数据追踪

项目已集成 Google Analytics，可以追踪以下数据：
- 页面访问量和用户数
- 图片上传次数
- 像素画生成次数
- 图纸下载次数（简洁版/完整版）
...
配置方法请查看 [ANALYTICS_SETUP.md](./ANALYTICS_SETUP.md)
